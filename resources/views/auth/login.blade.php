...
>
  <head>
    ...
    <meta name="description" content="Halaman login tenant sekolah" />
        ...
        <div class="authentication-inner">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Silakan masuk untuk mengelola tenant sekolah Anda</p>

              <form id="formAuthentication" class="mb-3" action="#" method="POST">
                @csrf
                <div class="mb-3">
                  <label for="school_id" class="form-label">ID Sekolah</label>
                  <input
                    type="text"
                    class="form-control"
                    id="school_id"
                    name="school_id"
                    placeholder="Contoh: 7241"
                    autofocus
                  />
                </div>
                <div class="mb-3">
