<!DOCTYPE html>
<html lang="id" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('template/assets') }}/" data-template="vertical-menu-template-free">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0">
    <title>Masuk | {{ config('app.name', 'Sekolah') }}</title>
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center mb-4">
                            <a href="{{ route('login') }}" class="app-brand-link gap-2">
                                            ...
                                            <g transform="translate(-27, -15)">
                                                <g transform="translate(27, 15)">
                                                    ...
                                                    <g transform="translate(19, 11) rotate(-300) translate(-19, -11)">
                                                        ...
                                                        <use fill-opacity="0.2" fill="#fff" xlink:href="#path-5"></use>
                                                    </g>
                                                </g>
                                            </g>
                                        </g>
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">{{ config('app.name', 'Sekolah') }}</span>
                            </a>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="mb-3" id="formAuthentication">
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="********" autocomplete="current-password" required>
